...
function winGame(){
  $(".table").html('<span class="winner"><strong>You did it!</strong><br>Bravo ! (sinon, le sucre c\'est avec modération)</span>');
  addNametags();
  finished = true;
  resetTable();
}
...
function loadLevel(){
  ...
  $(".level-header .level-text").html("Niveau " + (currentLevel+1) + " of " + levels.length);
