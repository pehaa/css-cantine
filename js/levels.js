var levels = [
  { 
    ...
    syntax : "A",
    help : "Par type en veut dire une balise (un tag) HTML ou XML, comme <tag>div</tag>, <tag>p</tag>, <tag>ul</tag>, <tag>assiette</tag> etc.",
    examples : [
  ...
  },
  {
    ...
    syntax: "#id",
    help : 'Avec le symbole <strong>#</strong> suivi (sans espace) par le nom d\'identifiant on peut cibler un élément par son <strong>id</strong>',
    examples : [
  ...
  },
  {
    ...
    syntax: "A&nbsp;&nbsp;B",
    help : "A&nbsp;&nbsp;B cible des <strong>B</strong> qui se trouvent dans les <strong>A</strong>.<br/> Attention à l'espace entre deux éléments.",
    examples : [
  ...
  },
  {
    ...
    syntax: ".classname",
    help : "Tu vas l\'utiliser souvent. Le symbole <strong>.</strong> suivi (sans espace) par le  nom de la classe permet de cibler tous les éléments qui ont cette classe.",
    examples : [
  ...
  },
  {
    ...
    syntax : "A, B",
    help : 'ceci permet de cibler en même temps les éléments <strong>A</strong> et <strong>B</strong>. On peut ainsi combiner plusieurs types de sélecteurs et en avoir plus de deux.',
    examples: [
  ...
  },
  {
    ...
    syntax: "A > B&nbsp;",
    doThis : "Je prends le toast, celui qui est posé directement sur l'assiette...",
    selector : "assiette > toast",
    helpTitle: "cible l'enfant direct d'un élément",
    help : "Avec le symbole <strong>></strong> on peut cibler des éléments qui sont des enfants directs d'un autre élément.",
    examples : [
  ...
  },
  {
    ...
    syntax : "A + B",
    help : "A + B cible tous les éléments <strong>B</strong> qui suivent (directement) les <strong>A</strong>.",
    examples : [
  ...
  },
  {
    ...
    helpTitle: "cible l'élément qui est le premier enfant de son élément parent",
  ...
  },
  {
    ...
    helpTitle: "Cible l'élément qui est le dernier enfant de son élément parent",
